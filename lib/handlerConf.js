...
(function() {
  ...
  exports.substitute = function(expr) {
    return expr.replace(/\seq\s/, ' === ').replace(/\sne\s/, ' !== ').replace(/\$date\b/, 'exports.date()').replace(/\$vhost\b/, 'exports.hostname()').replace(/\$ip\b/, 'exports.remote_ip()').replace(/\$(_*[a-zA-Z]\w*)/g, 'session.$1');
  };
