(function() {
   ...
   */
  var HandlerConf, Iconv, cipher, sid;
  ...
  HandlerConf = (function() {
     ...
     *
     */
    var basic, checkDate, checkLogonHours, date, encode_base64, encrypt, groupMatch, hostname, isInNet6, iso2unicode, remote_ip, token, unicode2iso;
