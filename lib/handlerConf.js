...
(function() {
  ...
  handlerConf = (function() {
    ...
    handlerConf.prototype.reload = function() {
      var a, aliases, cond, conf, h, headers, j, k, l, len, len1, len2, m, name, prot, ref, ref1, ref2, ref3, ref4, ref5, ref6, rule, rules, sessionStorageModule, sub, t, url, v, vConf, val, vhost, w;
      ...
      m = require("./sessions");
      this.sa = new m(sessionStorageModule, conf.globalStorageOptions);
    ...
    handlerConf.prototype.substitute = function(expr) {
      return expr.replace(/\seq\s/, ' === ').replace(/\sne\s/, ' !== ').replace(/\$date\b/, 'this.date()').replace(/\$vhost\b/, 'this.hostname()').replace(/\$ip\b/, 'this.remote_ip()').replace(/\$(_*[a-zA-Z]\w*)/g, 'session.$1');
    };

    handlerConf.prototype.date = function() {};

    handlerConf.prototype.hostname = function() {};

    handlerConf.prototype.remote_ip = function() {};
